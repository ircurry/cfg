...
I have packaged meow on my own so it is commented out here. I left it here because to show that it is an external dependency for my emacs configuration.
