...
I use tree-sitter for C, which unfortunately is not currently integrated into the default C major mode for Emacs.
...
Because this package contains GPL code from [[https://protesilaos.com/emacs/dotemacs#h:35b8a0a5-c447-4301-a404-bc274596238d][Protesilaos' configuration]] this section is GPL licensed. I intend to rewrite it entirely some time soon where I might dual license it as GPL and MIT.
