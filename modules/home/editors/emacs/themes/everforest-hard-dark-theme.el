...
(defvar everforest-hard-dark-colors-alist
  (let ((colors `(("everforest-hard-dark-accent"    . "#a7c080")
		  ...
		  ("everforest-hard-dark-bg-blue"   . "#384b55")
...
(everforest-hard-dark-with-color-variables
  (custom-theme-set-faces
   ...
   `(highlight           ((t (:background ,everforest-hard-dark-green :distant-foreground ,everforest-hard-dark-bg))))
   ...
   `(secondary-selection ((t (:background ,everforest-hard-dark-bg-blue))))
   ...
   ;; terminal mode
   `(term-color-black          ((t (:foreground ,everforest-hard-dark-bg-1 :background ,everforest-hard-dark-bg-1))))
   ...
   `(term-color-white          ((t (:foreground ,everforest-hard-dark-fg :background ,everforest-hard-dark-fg))))
   `(term-color-bright-black   ((t (:foreground ,everforest-hard-dark-silver :background ,everforest-hard-dark-silver))))
   `(term-color-bright-red     ((t (:foreground ,everforest-hard-dark-red :background ,everforest-hard-dark-red))))
   `(term-color-bright-green   ((t (:foreground ,everforest-hard-dark-green :background ,everforest-hard-dark-green))))
   `(term-color-bright-yellow  ((t (:foreground ,everforest-hard-dark-yellow :background ,everforest-hard-dark-yellow))))
   `(term-color-bright-blue    ((t (:foreground ,everforest-hard-dark-blue :background ,everforest-hard-dark-blue))))
   `(term-color-bright-magenta ((t (:foreground ,everforest-hard-dark-purple :background ,everforest-hard-dark-purple))))
   `(term-color-bright-cyan    ((t (:foreground ,everforest-hard-dark-cyan :background ,everforest-hard-dark-cyan))))
   `(term-color-bright-white   ((t (:foreground ,everforest-hard-dark-fg :background ,everforest-hard-dark-fg))))

   ;; vterm
   `(vterm-color-black ((t (:foreground ,everforest-hard-dark-bg-1 :background ,everforest-hard-dark-silver))))

   ;; ansi colors
   `(ansi-color-black          ((t (:foreground ,everforest-hard-dark-bg :background ,everforest-hard-dark-bg))))
   `(ansi-color-red            ((t (:foreground ,everforest-hard-dark-red :background ,everforest-hard-dark-red))))
   `(ansi-color-green          ((t (:foreground ,everforest-hard-dark-green :background ,everforest-hard-dark-green))))
   `(ansi-color-yellow         ((t (:foreground ,everforest-hard-dark-yellow :background ,everforest-hard-dark-yellow))))
   `(ansi-color-blue           ((t (:foreground ,everforest-hard-dark-blue :background ,everforest-hard-dark-blue))))
   `(ansi-color-magenta        ((t (:foreground ,everforest-hard-dark-purple :background ,everforest-hard-dark-purple))))
   `(ansi-color-cyan           ((t (:foreground ,everforest-hard-dark-cyan :background ,everforest-hard-dark-cyan))))
   `(ansi-color-white          ((t (:foreground ,everforest-hard-dark-fg :background ,everforest-hard-dark-fg))))
   `(ansi-color-bright-black   ((t (:foreground ,everforest-hard-dark-silver :background ,everforest-hard-dark-silver))))
   `(ansi-color-bright-red     ((t (:foreground ,everforest-hard-dark-red :background ,everforest-hard-dark-red))))
   `(ansi-color-bright-green   ((t (:foreground ,everforest-hard-dark-green :background ,everforest-hard-dark-green))))
   `(ansi-color-bright-yellow  ((t (:foreground ,everforest-hard-dark-yellow :background ,everforest-hard-dark-yellow))))
   `(ansi-color-bright-blue    ((t (:foreground ,everforest-hard-dark-blue :background ,everforest-hard-dark-blue))))
   `(ansi-color-bright-magenta ((t (:foreground ,everforest-hard-dark-purple :background ,everforest-hard-dark-purple))))
   `(ansi-color-bright-cyan    ((t (:foreground ,everforest-hard-dark-cyan :background ,everforest-hard-dark-cyan))))
   `(ansi-color-bright-white   ((t (:foreground ,everforest-hard-dark-fg :background ,everforest-hard-dark-fg))))
